...
function MotorsSensors() {
  traces = [];
  traces.push(addLine("Tr_Tacho", 1, window.rows));
  traces.push(addLine("Tr_Gyro", 1, window.rows));
  traces.push(addLine("Tr_uCmd", 2, window.rows));
...
function GyroCheck() {
  traces = [];
  traces.push(addLine("Tr_Gyro", 1, window.rows));
  traces.push(addLine("Tr_FFG", 2, window.rows));
...
Plotly.newPlot("plot", traces, layout, { editable: true });
  ...
  function Designation() {
    traces = [];
    traces.push(addLine("Tr_Tacho", 1, window.rows));
    traces.push(addLine("Tr_Resolver", 2, window.rows));
  ...
  Plotly.newPlot("plot", traces, layout, { editable: true });
    ...
    function Stabilization() {
      ...
      traces = [];
      traces.push(addLine("Tr_Gyro", 1, window.rows));
      traces.push(addLine("Tr_Gyro_int", 2, window.rows));
